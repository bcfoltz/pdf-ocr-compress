...
class PerformanceLogger:
    ...
    def log_processing_complete(self, file_path: Path, operation: str, 
                              duration: float, output_path: Path = None, **kwargs):
        ...
        if output_path and output_path.exists():
            extra_data.update({
                ...
                "compression_ratio": (file_path.stat().st_size / output_path.stat().st_size 
    ...
    def log_processing_error(self, file_path: Path, operation: str, error: str, **kwargs):
    ...
    def log_batch_complete(self, total_files: int, successful_files: int, 
                          failed_files: int, duration: float, success_rate: float, **kwargs):
...
def setup_logging(log_level: str = "INFO", log_file: Path = None, 
                 structured_logging: bool = True) -> logging.Logger:
    """
    ...
    if log_file:
        ...
        file_handler.setFormatter(JSONFormatter() if structured_logging 
